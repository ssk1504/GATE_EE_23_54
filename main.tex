...
\begin{figure}[ht]
  \centering
  \resizebox{0.8\columnwidth}{!}{\input{figs/ckt1}}
  \caption{Circuit 1}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.50\columnwidth}{!}{\input{figs/ckt2}}
  \caption{Circuit 2}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \resizebox{0.55\columnwidth}{!}{\input{figs/ckt3}}
  \caption{Circuit 3}
\end{figure}
